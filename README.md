...
<img src='https://github.com/michellecxu2000/codepath-twitter-sample/blob/master/SimpleTweetWalkthrough5.gif?raw=true' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Challenges: pulling data from Twitter, displaying the data, passing information from one activity to another
